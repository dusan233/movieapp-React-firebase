  ...
  render() {
    ...
    if (this.props.loading) {
      ...
      content = (
        <div className={styles.Container}>
          {this.props.popularSeries != null
            ? this.props.popularSeries.map(serie => {
                const serieData = {
                  ...serie,
    ...
    return (
      <div className={styles.Wrap}>
        <h1>20 Most Popular Tv Shows</h1>
        {content}
      </div>
    );
  }
...
const mapDispatchToProps = dispatch => {
  return {
    getPopularSeries: () => dispatch(actionCreator.fetchPopularSeries()),
